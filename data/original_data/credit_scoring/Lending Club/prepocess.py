...
#####process
data = get_data(os.path.join(current_dir, name)).values.tolist()
...
target_dir = '/Users/himanshu/Documents/Projects/CALM-train-TrustworthyNLP/data/split_data/Lending_Club_credit_scoring'
...
for i, temp in enumerate([train_data, dev_data, test_data]):
    json_save(temp, save_name[i], directory=target_dir)
