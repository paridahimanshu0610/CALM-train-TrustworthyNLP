...
os.chdir(curr_dir)
name = os.path.join(curr_dir, "taiwan.csv") 
...
os.makedirs('/Users/himanshu/Documents/Projects/CALM-train-TrustworthyNLP/data/split_data/Taiwan_Economic_Journal', exist_ok=True)
for i in range(len(data)):
    json_save(data[i], save_name[i], directory='/Users/himanshu/Documents/Projects/CALM-train-TrustworthyNLP/data/split_data/Taiwan_Economic_Journal')
